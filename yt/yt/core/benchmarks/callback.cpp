...
void Callback_Sum0(benchmark::State& state)
{
    ...
    while (state.KeepRunning()) {
        int x = callback.Run(1, 2, 3, 4, 5, 6);
        DoNotOptimizeAway(x);
    }
}
